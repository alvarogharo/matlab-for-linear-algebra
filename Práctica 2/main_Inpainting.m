...
Noise_STD   = 0.0; % desviaci�n t�pica del ruido AWGN
...
varin.lambda    =  ;      % hyperpar�metro de fidelidad
varin.Nit       =  ;      % n�mero de iteraciones del algoritmo
varin.dt        =  ;     % tama�o del paso 
